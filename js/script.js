...
$("#search-button").on("click", function () {
    ...
    newCityBtn.attr("class", "btn btn-primary");
...
//     console.log(city);
//     var queryURL = "http://api.openweathermap.org/data/2.5/find?q=" + city + "&units=imperial&appid=d8fde94eabbec07723a437c6948ea8a9";
//     getWeatherData();
